...
const marker2 = L.marker([53.325776, -6.341934]).addTo(map);
...
const marker7 = L.marker([53.324427, -6.420993]).addTo(map);
const marker8 = L.marker([53.322961, -6.389173]).addTo(map);
...
const marker12 = L.marker([53.298742, -6.164265]).addTo(map);
...
const marker17 = L.marker([53.320351, -6.409230]).addTo(map);
...
const marker22 = L.marker([53.342398, -6.338802]).addTo(map);
